...
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/V_x.png} % Adjust the width as needed
        \caption{$plot of V_x$}
\end{figure}
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/V_y.png} % Adjust the width as needed
        \caption{$plot of V_y$}
\end{figure}
\begin{figure}[h]
      \centering
       \includegraphics[width=1\linewidth]{figs/V_o.png} % Adjust the width as needed
        \caption{$plot of V_o$}
\end{figure}
\end{document}